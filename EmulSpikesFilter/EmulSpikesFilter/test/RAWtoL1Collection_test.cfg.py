...
process.schedule = cms.Schedule(process.raw2digi_step, process.ecallocalreco_step, process.L1Reco_step, process.endjob_step, process.filter, process.output_step)
